...
layout(location = 5) in vec4 inTangent;    // unused in shadow pass
layout(location = 6) in ivec4 inBoneIndices; // unused in shadow pass (static)
layout(location = 7) in vec4 inBoneWeights;  // unused in shadow pass (static)
