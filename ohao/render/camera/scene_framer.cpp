...
FrameResult SceneFramer::computeFraming(const std::vector<Vertex>& vertices, bool forceYUp) {
    ...
    result.lights = {
        ...
        {"CeilingLight", {0.0f, S * 0.9f, 2.0f}, {1.0f, 0.92f, 0.82f}, 60.0f, 3.0f},
        // Window light — cool daylight from the right
        {"WindowLight", {S * 0.8f, 3.0f, 5.0f}, {0.85f, 0.9f, 1.0f}, 50.0f, 4.0f},
        // Bedside lamp — warm point light on the nightstand
        {"BedsideLamp", {S * 0.55f, -S + 6.0f, -S + 2.0f}, {1.0f, 0.85f, 0.65f}, 20.0f, 1.0f},
        // Fill — subtle front fill to see the face
        {"FrontFill", {0.0f, 0.0f, S * 0.9f}, {1.0f, 0.95f, 0.9f}, 15.0f, 3.0f},
    };
