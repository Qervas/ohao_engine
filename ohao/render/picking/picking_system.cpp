...
Ray PickingSystem::screenToWorldRay(
    ...
    // glm::perspective() uses OpenGL depth range [-1, 1] (no GLM_FORCE_DEPTH_ZERO_TO_ONE)
    // Near plane in NDC is -1, far plane is 1
    glm::vec4 nearPointNDC = glm::vec4(ndcX, ndcY, -1.0f, 1.0f);
